...
void Stage::Battle(int stagesize)
{
	...
	case 1: Fox.SetMonster("북극 여우", 300, 30, 200);
		...
		break;
	case 2: Seal.SetMonster("북극 물개", 300, 30, 200);
		...
		break;
	case 3: Wolf.SetMonster("북극 늑대", 300, 30, 200);
		...
		break;
	case 4: PolorBear.SetMonster("북극 곰", 300, 30, 200);
...
void Stage::Bossbattle(int stagesize)
{
	...
	switch (stage)
	{
	case 1: CaptainFox.SetMonster("대장 북극 여우", 300, 30, 200);
		...
		isclaer1 = true;
		break;
	case 2: CaptainSeal.SetMonster("대장 북극 물개", 300, 30, 200);
		...
		isclaer2 = true;
		break;
	case 3: CaptainWolf.SetMonster("대장 북극 늑대", 300, 30, 200);
		...
		isclaer3 = true;
		break;
	case 4: CaptainPolorBear.SetMonster("폴라베어", 300, 30, 200);
